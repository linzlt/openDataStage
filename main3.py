...
def traiter_fichier(essai, axe_temps, chemin_figures):
    ...
    if os.path.exists(nom_fichier):
        ...
        if df_essai is not None:
            ...
            df_essai = convertir_colonnes_en_float(df_essai)
...
def main():
    ...
    futures = [
        client.submit(traiter_fichier, essai, axe_temps, chemin_figures)
        for essai in essais
    ]
